...
- [ ] [Deriving the lasso coordinate descent update - Feature Selection & Lasso | Coursera](https://www.coursera.org/lecture/ml-regression/deriving-the-lasso-coordinate-descent-update-6OLyn)

- [ ] [Deriving the lasso coordinate descent update - University of Washington | Coursera](https://www.coursera.org/learn/ml-regression/lecture/6OLyn/deriving-the-lasso-coordinate-descent-update)

- [ ] [Testing a Lasso Regression Model in Python - Lasso Regression | Coursera](https://www.coursera.org/lecture/machine-learning-data-analysis/testing-a-lasso-regression-model-in-python-aqEsh)

- [ ] [Statistical Machine Learning](https://www.stat.cmu.edu/~ryantibs/statml/)

- [ ] [(122) Lecture 14: Concentration of measure - YouTube](https://www.youtube.com/watch?v=K0H_eQcLsWM&feature=youtu.be&list=PLjbUi5mgii6B7A0nM74zHTOVQtTC9DaCv)


## 9/29/2019

- [ ] [All Content | Browse | Channel 9](https://channel9.msdn.com/Browse/AllContent?sort=rating&page=2&lang=en&lang=zh-cn)

- [ ] [An Introduction to Blockchain with Mark Russinovich | Seth Juarez | Channel 9](https://channel9.msdn.com/Blogs/Seth-Juarez/An-Introduction-to-Blockchain-with-Mark-Russinovich)

- [ ] [An Introduction to Microservices with Mark Russinovich | Seth Juarez | Channel 9](https://channel9.msdn.com/Blogs/Seth-Juarez/An-Introduction-to-Microservices-with-Mark-Russinovich)

- [ ] [Anders Hejlsberg: Introducing TypeScript | Channel 9](https://channel9.msdn.com/posts/Anders-Hejlsberg-Introducing-TypeScript)

- [ ] [C#: Object Oriented Programming - Catching Exceptions [19 of 19] | C# 101 | Channel 9](https://channel9.msdn.com/Series/CSharp-101/CSharp-Object-Oriented-Programming-Catching-Exceptions)

- [ ] [C#: Object Oriented Programming - Methods and Exceptions [18 of 19] | C# 101 | Channel 9](https://channel9.msdn.com/Series/CSharp-101/CSharp-Object-Oriented-Programming-Methods-and-Exceptions)

- [ ] [Creating Your First HTML5 Web Page - 02 | HTML5 & CSS3 Fundamentals: Development for Absolute Beginners | Channel 9](https://channel9.msdn.com/Series/HTML5-CSS3-Fundamentals-Development-for-Absolute-Beginners/Creating-Your-First-HTML5-Web-Page-02)

- [ ] [Generate Logic Apps and Flows to Publish Smart Contract Events to Streaming Data Sets in Power BI | Block Talk | Channel 9](https://channel9.msdn.com/Shows/Blocktalk/Generate-Logic-Apps-and-Flows-to-Publish-Smart-Contract-Events-to-Streaming-Data-Sets-in-Power-BI)

- [ ] [How to reduce inter-VM latency with Proximity Placement Groups | Azure Friday | Channel 9](https://channel9.msdn.com/Shows/Azure-Friday/How-to-reduce-inter-VM-latency-with-Proximity-Placement-Groups)

- [ ] [How to reserve a public IP range in Azure using Public IP Prefix | Azure Friday | Channel 9](https://channel9.msdn.com/Shows/Azure-Friday/How-to-reserve-a-public-IP-range-in-Azure-using-Public-IP-Prefix)

- [ ] [How to switch an existing Azure SQL Database from Provisioned Compute to Serverless | Data Exposed | Channel 9](https://channel9.msdn.com/Shows/Data-Exposed/How-to-switch-an-existing-Azure-SQL-Database-from-Provisioned-Compute-to-Serverless)

- [ ] [How to switch an existing Azure SQL Database from Provisioned Compute to Serverless | Data Exposed | Channel 9](https://channel9.msdn.com/Shows/Data-Exposed/How-to-switch-an-existing-Azure-SQL-Database-from-Provisioned-Compute-to-Serverless)

- [ ] [Python for Beginners [16 of 44] Demo: Dates | Python for Beginners | Channel 9](https://channel9.msdn.com/Series/Intro-to-Python-Development/Python-for-Beginners-16-of-44-Demo-Dates)
